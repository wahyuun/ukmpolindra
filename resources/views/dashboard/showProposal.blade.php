                ...
                <div class="col">
                    <div class="mb-1">
                        <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="#">Detail Proposal {{ $ukm->nama_ukm }}</a></li>
                        </ol>
                    </div>
                    <h2 class="page-title">
                        <span class="mx-auto">Data Proposal {{ $ukm->nama_ukm }}</span>
                    </h2>
                </div>
            </div>
        </div>
                    ...
                    <table class="table" id="myDashboardProposal">
                        <thead>
                            ...
                            <tbody>
                                ...
                                <td>
                                    @php
                                    $url_show = url('/ac-detailProposal?detail='.$prop->id);
                                    if ($prop->ukm->status != 0) {
